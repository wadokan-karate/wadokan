...
const ImageRights = () => {
    ...
    <>
        ...
        <div className=" ContainerImageRights bg-brown-300">
         ...
         <p className="text-md mt-4 mb-10 text-lg"> El formulario de autorización de derechos de imagen es un documento que otorga permiso para utilizar la imagen de una persona en diferentes contextos, como en fotografías, videos, publicaciones en redes sociales, publicidad y otros medios.
         ...
         <p className=" text-center text-md mt-6 mb-10 text-md text-red-800 font-semibold "> IMPORTANTE FIRMAR DOCUMENTO PDF Y SUBIR ARCHIVO EN EL FORMULARIO</p>
 
         <div className='Solicitud bg-wadokanBlue text-center mt-4 ml-80 mr-80 pt-2 pb-2 rounded-md font-bold hover:text-gray-200'>
