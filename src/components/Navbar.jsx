      ...
      {({ open }) => (
        <>
          <div className=" mx-auto max-w-7xl px-2 sm:px-3 lg:px-4">
            <div className="NavbarBox flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex  sm:hidden m-2">
                {/* Mobile menu button*/}
                <Disclosure.Button className="Navbarbutton inline-flex  rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
