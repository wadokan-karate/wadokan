...
export default function Footer(){
    return (
       ...
       <div className="bg-wadokanBlue">
        <div id="MainContainer" className=" bg-wadokanBlue container py-16 2xl:px-20 lg:px-12 px-4">
                ...
                <div className="flex flex-col flex-shrink-0 justify-center">
                    ...
                    <div className="flex items-center gap-x-4 mt-12">
                        <div className="opacity-50 w-8 h-8 flex-shrink-0 bg-gray-800 cursor-pointer hover:bg-gray-700 rounded-full flex items-center justify-center">
                            <svg width="18" height="17" viewBox="0 0 18 17" fill="none" href="https://www.instagram.com/karatewadokan/">
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
