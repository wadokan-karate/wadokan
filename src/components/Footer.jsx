...
export default function Footer(){
    return (
       ...
       <div className="MainContainer bg-wadokanBlue flex justify-center" >
        <div className=" h-full bg-wadokanBlue container py-16 2xl:px-20 lg:px-12 px-4">
            <div className="  grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
                <div className="flex flex-col flex-shrink-0 justify-center">
                    <div>
                        <svg width="57" height="17" viewBox="0 0 57 17" fill="none" src="src\assets\img\logo2.png">
                            <path
