    ...
    return (
        <div>
            ...
            <div className="gearContainer">
                ...
                <img className='gearPhoto' src="src\assets\img\Gear1.png" alt="Equipación, primera imagen" />
                <img className='gearPhoto' src="src\assets\img\Gear2.png" alt="Equipación, segunda imagen" />
