      ...
      <>
       ...
       <section className=" dark:bg-gray-900 text-start">
          ...
          <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-lg"> En este formulario podrás enviar los datos de tu hijo a nuestro correo. Gracias a esto las profes tendrán una información más clara de cada alumno para hacer la inscripción oficial, muchas gracias ! </p>

            <form action="https://formsubmit.co/ef4f1ed50a256535f4e05d0cb2fa7041" method="POST" className="space-y-8">
              <div>
                <label htmlFor="subject" className="block mb-2 text-lg font-medium text-gray-900 dark:text-gray-300">Nombre y Apellidos del Participante</label>
              ...
              <div>
                <label htmlFor="subject" className="block mb-2 text-lg font-medium text-gray-900 dark:text-gray-300">Color de cinturón</label>
