      ...
      <li>
        ...
        <aside className="asidep-6 h-full sm:w-60 bg-blue-gray-600 text-blue-gray-50">
            <nav className="space-y-8 text-sm">
                ...
                <div className=" bg-wadokanBlue text-blue-gray-900  mb-4 ml-4 m-10 p-3 rounded-md">
                    <a  className="text-lg ml-12 font-semibold    hover:bg-wadokanBlue hover:text-blue-gray-900"href="/">HOME</a>
                </div>               
