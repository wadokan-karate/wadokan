    ...
    return (
        ...
        <div className="legal">
            ...
            <p>En cumplimiento del artículo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y Comercio Electrónico, el Titular expone sus datos identificativos:</p>
                <ul>
                    <li><strong>Titular:</strong>  ..........</li>
                    <li><strong>NIF:</strong> 00000000A</li>
                    <li><strong>Domicilio:</strong>  Calle .... Sevilla - España</li>
                    <li><strong>Correo electrónico:</strong>  info@wadokan.es</li>
                    <li><strong>Teléfono de contacto</strong>:  666666666</li>
                    <li><strong>Sitio Web:</strong>  https://wadokan.es</li>
                </ul>
            ...
            <p>Puede consultar toda la información relativa al tratamiento de datos personales que recoge el Titular en la página de <Link to="/politica-privacidad">Política de Privacidad</Link>.</p>
            ...
            <p>Puede consultar toda la información relativa a la política de recogida y tratamiento de las cookies en la página de <Link to="/politica-cookies">Política de Cookies</Link>.</p>
            ...
            <h2>Contacto</h2>
            <p>En caso de que usted tenga cualquier duda acerca de este Aviso Legal o quiera realizar cualquier comentario sobre el Sitio Web, puede enviar un mensaje de correo electrónico a la dirección: info@wadokan.es</p>
        </div>
        </>
    );
};
